...
Couleur Couleur::operator+(const Couleur& couleur) const
{
	...
	c.setRouge(c.getRouge() + couleur.getRouge());
	c.setVert(c.getVert() + couleur.getVert());
	c.setBleu(c.getBleu() + couleur.getBleu());
...
Couleur operator+(int valCouleur, const Couleur& couleur)
{
	...
	c.setRouge(valCouleur + couleur.getRouge());
	c.setVert(valCouleur + couleur.getVert());
	c.setBleu(valCouleur + couleur.getBleu());
